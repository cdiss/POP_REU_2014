...
int main(int argc, char* argv[]) {
    ...
    fprintf(out, "|OpenMP 4.0          %9.2f %9.2f %9.2f %9.2f          %9.2f\n", data[15], data[16], data[17], data[18], data[19]);
    fprintf(out, "|ISPC                %9.2f %9.2f %9.2f %9.2f          %9.2f\n", data[20], data[21], data[22], data[23], data[24]);
    fprintf(out, "--------------------------------------------------------------\n\n");
    fprintf(out, "----------------AVX-------------------------------------------\n");
    fprintf(out, "|                        ---------- Unrolling level ----------\n");
    fprintf(out, "|                        1         2         4         8          Single-Threaded\n");
    ...
    fprintf(gnutablesse2, "REFERENCE SERIAL,1,%f,%f,%f,%f,%f\n", data[0], data[1], data[2], data[3], data[4]);
    fprintf(gnutablesse2, "Intrinsics,2,%f,%f,%f,%f,%f\n", data[5], data[6], data[7], data[8], data[9]);
    fprintf(gnutablesse2, "Intel vectorization,3,%f,%f,%f,%f,%f\n", data[10], data[11], data[12], data[13], data[14]);
    fprintf(gnutablesse2, "OpenMP 4.0,4,%f,%f,%f,%f,%f\n", data[15], data[16], data[17], data[18], data[19]);
    fprintf(gnutablesse2, "ISPC,5,%f,%f,%f,%f,%f\n", data[20], data[21], data[22], data[23], data[24]);
    fclose(gnutablesse2);
    ...
    fprintf(gnutableavx, "REFERENCE SERIAL,1,%f,%f,%f,%f,%f\n", data[25], data[26], data[27], data[28], data[29]);
    fprintf(gnutableavx, "Intrinsics,2,%f,%f,%f,%f,%f\n", data[30], data[31], data[32], data[33], data[34]);
    fprintf(gnutableavx, "Intel vectorization,3,%f,%f,%f,%f,%f\n", data[35], data[36], data[37], data[38], data[39]);
    fprintf(gnutableavx, "OpenMP 4.0,4,%f,%f,%f,%f,%f\n", data[40], data[41], data[42], data[43], data[44]);
    fprintf(gnutableavx, "ISPC,5,%f,%f,%f,%f,%f\n", data[45], data[46], data[47], data[48], data[49]);
    fclose(gnutableavx);
    ...
    fprintf(gnutablephi, "REFERENCE SERIAL,1,%f,%f,%f,%f,%f\n", data[50], data[51], data[52], data[53], data[54]);
    fprintf(gnutablephi, "Intrinsics,2,%f,%f,%f,%f,%f\n", data[55], data[56], data[57], data[58], data[59]);
    fprintf(gnutablephi, "Intel vectorization,3,%f,%f,%f,%f,%f\n", data[60], data[61], data[62], data[63], data[64]);
    fprintf(gnutablephi, "OpenMP 4.0,4,%f,%f,%f,%f,%f\n", data[65], data[66], data[67], data[68], data[69]);
    fprintf(gnutablephi, "ISPC,5,%f,%f,%f,%f,%f\n", data[70], data[71], data[72], data[73], data[74]);
    fclose(gnutablephi);
